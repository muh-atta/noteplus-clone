...
export default function Sidebar({ onClose }: { onClose: () => void }) {
  ...
  lg:rounded-t-xl p-5 space-y-6"
    >
      ...
      <button className="flex items-center justify-between w-full p-2.5 rounded-xl hover:bg-gray-100 transition">
      ...
      <button className="flex items-center justify-between w-full p-3 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition">
        <div className="flex items-center space-x-3">
      ...
      <div className="mt-auto">
        {/* Save your illustration (e.g., rocket.svg) in the `/public` folder 
        ...
        */}
        ...
        {/* <div className="h-40 w-full bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg flex items-center justify-center p-4">
          <span className="text-sm text-indigo-500 text-center">
